...
# go.sh / orchestrate 依賴每個 spider run 寫出 ./scrapy.log（mv 成
# ../logs/*.log 歸檔＋breaker/error 掃描），所以這是 repo 層的契約，
# 不是個人偏好設定。batch 迴圈的控制流已改走 stop_marker 檔（dx 4-2），
# 不再依賴 log 字串
LOG_FILE = 'scrapy.log'
