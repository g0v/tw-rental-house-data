'''rawpack（twrhctl 版，無 Django；由 django/rental/management/commands/rawpack.py 搬來。
對帳只讀檔案 queue——TWRH_QUEUE_DB=1 拒跑）。

原說明：rawpack：把當日 raw scratch 打成日包（architecture-roadmap 3-1 finalize）。
