'''qualitycheck（twrhctl 版，無 Django；由 django 同名指令搬來，行為相同）。

原說明：qualitycheck：assertions.yaml × 當日 manifest ＝ 單一告警通道（1-2）。
...
from crawlerrequest import manifest_files, quality
from crawlerrequest import manifest_files as manifests   # load_manifest 同一支
