...
def unquote_js_string(raw_value):
    """
    strip the quotes of a JS string value and read its escapes
    '"元\\u002F月"' -> '元/月', '12' -> '12'
    """
...
class SimpleNuxtInitParser:
    ...
    def list_values(self):
        ...
        # "12,345", "市中心,拎包入住,含車位", or an inline style with
        # "rgb(20, 106, 153)", stays in one piece. Splitting those apart
        # shifts every following value by one, which silently maps each
        # argument to a wrong value.
        return [
