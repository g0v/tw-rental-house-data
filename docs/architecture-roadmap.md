...
| S3b house 三表停寫 | S3a 三次一致 | house／house_ts 停寫；synthts／syncstateful 退役 | 9/20–21（原 9/21→9/19–20） |
| S5 RDS 收尾 | S1–S4 全完成、house 三表停寫（DB 無任何讀寫點） | 留最後一份 RDS snapshot → **destroy（九月內，維護者明講授權；屆時另行確認一次）**。**不再補一次 RDS export**（2026-09-17 拍板）：archive 裡那份 16:32 snapshot 的八表包就是最終歷史，destroy 當下留的 RDS snapshot 另作保險 | 9/22 前後 |
