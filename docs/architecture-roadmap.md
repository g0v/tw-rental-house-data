...
| S5 RDS 收尾 | S1–S4 全完成、house 三表停寫（DB 無任何讀寫點） | 留最後一份 RDS snapshot → **destroy（九月內，維護者明講授權；9/17 再確認＝屆時另行確認一次）** | 9/22 前後 |
