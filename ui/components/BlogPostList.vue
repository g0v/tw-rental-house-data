<template lang="pug">
  .flex.flex-wrap.justify-center
    .mw6-l.w-33-l.w-100.fl.relative(v-for="post in posts" :key="post.slug")
      article.aspect-ratio--1x1(itemscope itemtype="http://schema.org/Article")
        nuxt-link.pa3.h-100.w-100.dim.no-underline.db.absolute(itemprop="url" :to="`/blog/post/${post.slug}/`")
          .post.br2.ba.b--moon-gray.h-100.overflow-hidden
            ...
            .post__footer.bt.b--moon-gray.flex.justify-between.light-silver
              ...
              .dib.f6(itemprop="datePublished dateModified" :content="post.created")
...
export default {
  ...
  methods: {
    contentCreated (post) {
      return new Date(post.created).toLocaleDateString()
    }
  }
}
</script>
